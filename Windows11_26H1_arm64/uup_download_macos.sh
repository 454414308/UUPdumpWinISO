...
aria2c --no-conf --console-log-level=warn --log-level=info --log="aria2_download.log" -o"$tempScript" --allow-overwrite=true --auto-file-renaming=false "https://uupdump.net/get.php?id=5ee05231-b479-40cf-8ea4-c0202e66f100&pack=zh-cn&edition=professional&aria2=2"
if [ $? != 0 ]; then
